                  ...
                  {user &&
                        <section id="contact">
                            ...
                            <form enctype="multipart/form-data">
                                ...
                                <button  onClick={(e)=>{dispatch(editUser(user._id,{name : nomP,adresse : adresseP,email : emailP,phone : phoneP,profession : professionP,birth : dateP , userImage : picP,description : descriptionP})); history.push('/Profile')}}>Modifier</button><br/>
                            </form>
                        </section>
                  }  
